...
encoder_path={'efficientvit_l2':'/data/pretrained_weights/mobilesamv2/l2.pt',
            'tiny_vit':'/data/pretrained_weights/mobilesamv2/mobile_sam.pt',
            'sam_vit_h':'/data/pretrained_weights/mobilesamv2/sam_vit_h.pt',}
