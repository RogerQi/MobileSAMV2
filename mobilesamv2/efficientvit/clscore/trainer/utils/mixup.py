...
from mobilesamv2.efficientvit.apps.data_provider.augment import rand_bbox
from mobilesamv2.efficientvit.models.utils.random import torch_randint, torch_shuffle
